...
// Hiện diện foreground đi theo SSE/Redis TTL. Business EventSource tự gia hạn key khoảng 30 giây;
// PostgreSQL polling vẫn giữ realtime hoạt động khi Redis lỗi. Android tiếp tục dùng heartbeat HTTP
// làm lưới an toàn khi ở nền, còn SignalR chỉ phục vụ communication chat/call/P2P.
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // (Hiện diện online đã chuyển sang SSE/Redis — xem ghi chú ở đầu tệp.)
