...
// Business realtime is installed by DatabaseChangePublisher into the transactional integration
// outbox and reaches clients through SSE. SignalR remains registered only for communication legacy.
...
// Communication legacy only: chat/call/P2P. Business realtime is SSE above.
if (app.Configuration.GetValue("Realtime:LegacySignalREnabled", true))
