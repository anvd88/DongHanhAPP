...
export const NAV: NavSection[] = [
  ...
  },
  {
    title: "NHÂN SỰ",
    items: [
      { key: "hoso", label: "Hồ sơ của tôi", icon: IdCard, path: "/hoso", ready: true },
      { key: "bangcong", label: "Bảng công", icon: CalendarClock, path: "/bangcong", ready: true },
      { key: "dontu", label: "Đơn từ", icon: FileText, path: "/dontu", ready: true },
      { key: "pheduyet", label: "Phê duyệt", icon: Inbox, path: "/pheduyet", ready: true },
